...
async function getMarketCodes() {
    ...
    return marketCodes.json();
}

export const marketCodes = await getMarketCodes();

async function createCountriesMap() {
    const countryNames = new Map();
    for(let code of marketCodes.markets) {
        countryNames.set(countryCodes[code], code);
    }
    return countryNames;
}

export let countryNamesMap = await createCountriesMap();